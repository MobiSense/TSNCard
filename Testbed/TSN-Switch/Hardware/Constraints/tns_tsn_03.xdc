...
set_output_delay -clock [get_clocks -of [get_pins clk_wiz_0_i/clk50]] 1.000 [get_ports {mdc[*]}]
...
set _xlnx_shared_i2 [get_cells -hier -filter {name =~ *cpu_header_rm_i/m_axis*}]
set_multicycle_path -setup -end -from [get_pins example_resets/gtx_resetn_reg/C] -to $_xlnx_shared_i2 2
set_multicycle_path -hold -end -from [get_pins example_resets/gtx_resetn_reg/C] -to $_xlnx_shared_i2 1
...
############################################################
# Flow Control Clock Crossing Constraints                  #
############################################################

# double flip-flop synchronizer has been added between rx_fifo_status and pause_val & pause_req
set_false_path -from [get_cells -hierarchical *rx_fifo_status_slow_reg*] -to [get_cells -hierarchical *rx_fifo_status_slow_q1*]
